...
jQuery(document).ready(function(){"use strict";$('[data-toggle="tooltip"]').tooltip(),$('[data-toggle="popover"]').popover(),$(".dropdown a.dropdown-toggle").click(function(){location.href=$(this).attr("href")}),wheelzoom(document.querySelector("img.zoom")),$(".projects_slider").owlCarousel({navigation:!0,navigationText:["",""],pagination:!1,slideSpeed:700,autoPlay:5e3,items:4,itemsDesktop:[600,2],margin:10,autoHeight:!0}),$(".mfp-gallery").each(function(){$(this).magnificPopup({delegate:"a",mainClass:"mfp-zoom-in",type:"image",tLoading:"",image:{verticalFit:!0,titleSrc:function(t){return t.el.attr("title")}},gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1],arrowMarkup:'<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>',tPrev:"Previous (Left arrow key)",tNext:"Next (Right arrow key)",tCounter:'<span class="mfp-counter">%curr% of %total%</span>'},removalDelay:300,callbacks:{beforeChange:function(){this.items[0].src=this.items[0].src+"?="+Math.random()},open:function(){$.magnificPopup.instance.next=function(){var t=this;t.wrap.removeClass("mfp-image-loaded"),setTimeout(function(){$.magnificPopup.proto.next.call(t)},120)},$.magnificPopup.instance.prev=function(){var t=this;t.wrap.removeClass("mfp-image-loaded"),setTimeout(function(){$.magnificPopup.proto.prev.call(t)},120)}},imageLoadComplete:function(){var t=this;setTimeout(function(){t.wrap.addClass("mfp-image-loaded")},16)}}})}),$("#myModal").on("shown.bs.modal",function(){$("#myInput").trigger("focus")}),$(".open-popup").magnificPopup({type:"inline",midClick:!0,removalDelay:500,callbacks:{beforeOpen:function(){this.st.mainClass=this.st.el.attr("data-effect")}}}),$("a[rel^='prettyPhoto']").prettyPhoto(),$('input[name="fz152"]').change(function(){this.checked?$(this).closest("form").find('[type="submit"]').prop("disabled",!1):$(this).closest("form").find('[type="submit"]').prop("disabled",!0)}),$(document).on("af_complete",function(t,e){e.form;1==e.success&&$("#volonter").modal("hide")})}()),jQuery("#backtotop").click(function(){jQuery("body,html").animate({scrollTop:0},600)}),jQuery(window).scroll(function(){150<jQuery(window).scrollTop()?jQuery("#backtotop").addClass("visible"):jQuery("#backtotop").removeClass("visible")});